...
const Hangman = () => {
  ...
  useEffect(() => {
    ...
    // <div>mening:{mean[0].meanings[0].definitions[0].definition}</div>
  }, [ada]);
  ...
  useEffect(() => {
    axios(`https://api.dictionaryapi.dev/api/v2/entries/en/${ans}`).then(
      (e) => {
        setmean(e.data);
      }
    );
      ...
      <div className={dark ? "dark" : ""}>
        <div className="dar flex justify-center items-center big-bg h-screen w-full flex-col relative">
          ...
          <div className="absolute">
            {see==0 ? (<div className=" h-80  flex justify-center items-center win rounded-md flex-col animate__animated animate__lightSpeedInLeft">
              <div className="text-xl">{ans}</div>
              <div className='p-2 w-full'>mening:{mean[0].meanings[0].definitions[0].definition}</div>
              <div
            ...
            :check_time == ans.length ? (
              <div className="w-80 h-80  flex justify-center items-center win rounded-md flex-col animate__animated animate__lightSpeedInLeft">
                ...
                <div className="w-32 h-12 flex justify-center items-center big-btn rounded-md mt-2" onClick={()=>notsee(0)}>
          ...
          <div className="absolute bottom-0 text-[#3b5998] dark:text-[#f2f2f2] ">
            {dark ? (
              <Typed
                key="typing-1"
                strings={["made by LIMING from MRGA"]}
                typeSpeed={40}
                loop={false}
              />
            ) : (
